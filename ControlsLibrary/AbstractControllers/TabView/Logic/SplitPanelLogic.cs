...
//            //_separator = new SeparatorLogic(factory.CreateSeparator(), Height, relativePosition);
...
//                    Separator.Location = new Point(Separator.Location.X, Panel1.Height);
//                    Panel2.Location = new Point(Panel2.Location.X, Panel1.Height + Separator.Height);
//                    Panel2.Height = Height - Panel1.Height - Separator.Height;
//                    break;
//                case Orientation.Vertical:
//                    Panel1.Width = (int)(Width * ratio);
//                    Separator.Location = new Point(Panel1.Width, Separator.Location.Y);
//                    Panel2.Location = new Point(Panel1.Width + Separator.Width, Panel2.Location.Y);
//                    Panel2.Width = Width - Panel1.Width - Separator.Width;
//                    break;
//            }
//        }
//    }
